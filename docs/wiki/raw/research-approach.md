...
内容类型：已发表论文解读与技术思考
主题：研究方法
页面：https://hreyulog.github.io/wiki/research-approach.html

将表示学习、可解释建模与可靠评测串起来：先定义问题，再讨论模型是否真的解决了问题。
...
- [代码不仅是文本，也是协作留下的轨迹](https://hreyulog.github.io/wiki/code-dynamics.html)
- [轻量化不是单纯把模型变小](https://hreyulog.github.io/wiki/efficient-models.html)
